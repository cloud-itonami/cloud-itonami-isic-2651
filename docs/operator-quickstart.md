# Operator Quickstart — Manufacture of measuring, testing, navigating and control equipment

Shortest path from clone to a verified local dry-run for **ISIC 2651** (`cloud-itonami-isic-2651`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2651.git
cd cloud-itonami-isic-2651
```
...
- Blueprint governor key: `measuring-control-equipment-plant-operations-governor`
- Likely source path: `measctrlmfg.governor.cljc`
