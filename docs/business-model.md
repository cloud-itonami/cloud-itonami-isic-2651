# Business Model: Manufacture of measuring, testing, navigating and control equipment
...
## Classification
- Repository: `cloud-itonami-isic-2651` ([github.com/cloud-itonami/cloud-itonami-isic-2651](https://github.com/cloud-itonami/cloud-itonami-isic-2651))
- ISIC Rev.5: `2651` — Manufacture of measuring, testing, navigating and control equipment
- Domain: `:measuring-control-instrument/manufacturing`
- Social impact: :worker-safety :process-safety :measurement-integrity
- Actor: `:measuring-control-equipment-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :measuring-control-instrument/manufacturing — who wants
...
One managed tenant (:measuring-control-instrument/manufacturing):
...
- Do not bypass the `:measuring-control-equipment-plant-operations-governor` for production decisions.
