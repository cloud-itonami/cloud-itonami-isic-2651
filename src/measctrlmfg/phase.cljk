(ns measctrlmfg.phase
  "Phase 0->3 staged rollout for the measuring/testing/navigating/
  control-equipment plant-operations coordination actor.
  ...
  consequence (a calibration-bench/assembly-line/test-bench-equipment
  ...
  `measctrlmfg.governor`'s `actuate-equipment-blocked-violations` HARD-
...
(defn verdict->disposition
  "Map a Measuring Control Equipment Plant Operations Governor verdict
